pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'MONIT_RELEASE'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-monit'
    CONTAINER_NAME = 'monit'
    DOCKERHUB_IMAGE = 'linuxserver/monit'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/monit'
    PR_DOCKERHUB_IMAGE = 'lspipepr/monit'
    DIST_IMAGE = 'alpine'
    DIST_TAG = '3.14'
    DIST_REPO = 'http://dl-cdn.alpinelinux.org/alpine/v3.14/main/'
    DIST_REPO_PACKAGES = 'monit'
    MULTIARCH = 'true'
    CI='true'
    CI_WEB='true'
    CI_PORT='80'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-monit/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-monit\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-monit\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Monit\" \
          --label \"org.opencontainers.image.description=[monit](https://www.monit.com/products/open-source-log-management/) is a small Open Source utility for managing and monitoring Unix systems.\" \
